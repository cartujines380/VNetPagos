...
{
    public class SystemUserClientService : WebApiClientService, ISystemUserClientService
    {
        public SystemUserClientService(ITransactionContext transactionContext)
            : base("SystemUser", transactionContext)
        {
