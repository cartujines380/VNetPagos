...
{
    public class DiscountCalculationServiceInModel
    {
        /// <summary>
        ...
        /// </summary>
        [Required(AllowEmptyStrings = false, ErrorMessageResourceType = typeof(LIFStrings), ErrorMessageResourceName = "ServiceId_Required")]
