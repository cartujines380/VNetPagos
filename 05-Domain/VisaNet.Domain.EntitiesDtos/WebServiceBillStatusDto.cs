...
{
    public class WebServiceBillStatusDto
    {
        public int CodResultado { get; set; }
        public string DescResultado { get; set; }
        public ICollection<WebServiceEstadoFacturasDto> EstadoFacturas { get; set; }
        public WebServiceResumenPagosDto ResumenPagos { get; set; }
    }

    public class WebServiceResumenPagosDto
    {
    ...
    public class WebServiceEstadoFacturasDto
    {
