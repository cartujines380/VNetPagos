...
namespace VisaNet.WebService.VisaNetPagosWCF.EntitiesModel
{
    ...
    /// </summary>
    [DataContract]
    public class VNPRespuestaConsultaUrlTransaccion
    {
        /// <summary>
        ...
        /// <summary>
        /// Informacion enviada a url_transaccion
        /// </summary>
        [DataMember]
        public IList<WebhookUrlTransactionModel> ListadoLlamadasUrlTransaccion { get; set; }
