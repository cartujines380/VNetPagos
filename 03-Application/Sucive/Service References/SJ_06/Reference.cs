...
namespace Sucive.SJ_06 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="GeoTribUy", ConfigurationName="SJ_06.Ws06ReversoSoapPort")]
    public interface Ws06ReversoSoapPort {
        ...
        Sucive.SJ_06.ExecuteResponse Execute(Sucive.SJ_06.ExecuteRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="GeoTribUyaction/AWS06REVERSO.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Sucive.SJ_06.ExecuteResponse> ExecuteAsync(Sucive.SJ_06.ExecuteRequest request);
    }
    ...
    public partial class ExecuteRequest {
        ...
        public Sucive.SJ_06.ExecuteRequestBody Body;
        
        public ExecuteRequest() {
        }
        
        public ExecuteRequest(Sucive.SJ_06.ExecuteRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ExecuteResponse {
        ...
        public Sucive.SJ_06.ExecuteResponseBody Body;
        
        public ExecuteResponse() {
        }
        
        public ExecuteResponse(Sucive.SJ_06.ExecuteResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Ws06ReversoSoapPortChannel : Sucive.SJ_06.Ws06ReversoSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Ws06ReversoSoapPortClient : System.ServiceModel.ClientBase<Sucive.SJ_06.Ws06ReversoSoapPort>, Sucive.SJ_06.Ws06ReversoSoapPort {
        ...
        Sucive.SJ_06.ExecuteResponse Sucive.SJ_06.Ws06ReversoSoapPort.Execute(Sucive.SJ_06.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public string Execute(long Numeroprefactura, int Idpadcod, out string Mensajeretorno) {
            Sucive.SJ_06.ExecuteRequest inValue = new Sucive.SJ_06.ExecuteRequest();
            inValue.Body = new Sucive.SJ_06.ExecuteRequestBody();
            inValue.Body.Numeroprefactura = Numeroprefactura;
            inValue.Body.Idpadcod = Idpadcod;
            Sucive.SJ_06.ExecuteResponse retVal = ((Sucive.SJ_06.Ws06ReversoSoapPort)(this)).Execute(inValue);
            Mensajeretorno = retVal.Body.Mensajeretorno;
            return retVal.Body.Codigoretorno;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Sucive.SJ_06.ExecuteResponse> Sucive.SJ_06.Ws06ReversoSoapPort.ExecuteAsync(Sucive.SJ_06.ExecuteRequest request) {
            return base.Channel.ExecuteAsync(request);
        }
        
        public System.Threading.Tasks.Task<Sucive.SJ_06.ExecuteResponse> ExecuteAsync(long Numeroprefactura, int Idpadcod) {
            Sucive.SJ_06.ExecuteRequest inValue = new Sucive.SJ_06.ExecuteRequest();
            inValue.Body = new Sucive.SJ_06.ExecuteRequestBody();
            inValue.Body.Numeroprefactura = Numeroprefactura;
            inValue.Body.Idpadcod = Idpadcod;
            return ((Sucive.SJ_06.Ws06ReversoSoapPort)(this)).ExecuteAsync(inValue);
        }
    }
}
