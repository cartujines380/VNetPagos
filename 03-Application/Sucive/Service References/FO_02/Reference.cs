...
namespace Sucive.FO_02 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="GeoTribUy", ConfigurationName="FO_02.Ws02BusquedaCCSoapPort")]
    public interface Ws02BusquedaCCSoapPort {
        ...
        Sucive.FO_02.ExecuteResponse Execute(Sucive.FO_02.ExecuteRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="GeoTribUyaction/AWS02BUSQUEDACC.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Sucive.FO_02.ExecuteResponse> ExecuteAsync(Sucive.FO_02.ExecuteRequest request);
    }
    ...
    public partial class ExecuteRequest {
        ...
        public Sucive.FO_02.SDT_BusquedaCargadaSDT_BusquedaCargadaItem[] Sdtbusquedacargada;
        
        public ExecuteRequest() {
        }
        
        public ExecuteRequest(string Tipopadron, Sucive.FO_02.SDT_BusquedaCargadaSDT_BusquedaCargadaItem[] Sdtbusquedacargada) {
    ...
    public partial class ExecuteResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="GeoTribUy", Order=0)]
        [System.Xml.Serialization.XmlArrayItemAttribute(IsNullable=false)]
        public Sucive.FO_02.SDT_DatosdePadronesCCSDT_DatosdePadronesCCItem[] Sdtdatosdepadronescc;
        ...
        public ExecuteResponse(Sucive.FO_02.SDT_DatosdePadronesCCSDT_DatosdePadronesCCItem[] Sdtdatosdepadronescc, string Codigoretorno, string Mensajeretorno) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Ws02BusquedaCCSoapPortChannel : Sucive.FO_02.Ws02BusquedaCCSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Ws02BusquedaCCSoapPortClient : System.ServiceModel.ClientBase<Sucive.FO_02.Ws02BusquedaCCSoapPort>, Sucive.FO_02.Ws02BusquedaCCSoapPort {
        ...
        Sucive.FO_02.ExecuteResponse Sucive.FO_02.Ws02BusquedaCCSoapPort.Execute(Sucive.FO_02.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public Sucive.FO_02.SDT_DatosdePadronesCCSDT_DatosdePadronesCCItem[] Execute(string Tipopadron, Sucive.FO_02.SDT_BusquedaCargadaSDT_BusquedaCargadaItem[] Sdtbusquedacargada, out string Codigoretorno, out string Mensajeretorno) {
            Sucive.FO_02.ExecuteRequest inValue = new Sucive.FO_02.ExecuteRequest();
            inValue.Tipopadron = Tipopadron;
            inValue.Sdtbusquedacargada = Sdtbusquedacargada;
            Sucive.FO_02.ExecuteResponse retVal = ((Sucive.FO_02.Ws02BusquedaCCSoapPort)(this)).Execute(inValue);
            Codigoretorno = retVal.Codigoretorno;
            Mensajeretorno = retVal.Mensajeretorno;
            return retVal.Sdtdatosdepadronescc;
        }
        
        public System.Threading.Tasks.Task<Sucive.FO_02.ExecuteResponse> ExecuteAsync(Sucive.FO_02.ExecuteRequest request) {
