...
namespace Sucive.MA_08 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="GeoTribUy", ConfigurationName="MA_08.Ws08bCobradoDetalleSoapPort")]
    public interface Ws08bCobradoDetalleSoapPort {
        ...
        Sucive.MA_08.ExecuteResponse Execute(Sucive.MA_08.ExecuteRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="GeoTribUyaction/AWS08BCOBRADODETALLE.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Sucive.MA_08.ExecuteResponse> ExecuteAsync(Sucive.MA_08.ExecuteRequest request);
    }
    ...
    public partial class ExecuteResponse {
        ...
        public Sucive.MA_08.SDT_WS08bTotalesCobrosSDT_WS08bTotalesCobrosItem[] Sdttotales;
        ...
        public ExecuteResponse(Sucive.MA_08.SDT_WS08bTotalesCobrosSDT_WS08bTotalesCobrosItem[] Sdttotales, double Totalcobrado, int Cantidadcobros, string Codigoretorno, string Mensajeretorno) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Ws08bCobradoDetalleSoapPortChannel : Sucive.MA_08.Ws08bCobradoDetalleSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Ws08bCobradoDetalleSoapPortClient : System.ServiceModel.ClientBase<Sucive.MA_08.Ws08bCobradoDetalleSoapPort>, Sucive.MA_08.Ws08bCobradoDetalleSoapPort {
        ...
        Sucive.MA_08.ExecuteResponse Sucive.MA_08.Ws08bCobradoDetalleSoapPort.Execute(Sucive.MA_08.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public Sucive.MA_08.SDT_WS08bTotalesCobrosSDT_WS08bTotalesCobrosItem[] Execute(long Nrocobrodesde, long Nrocobrohasta, System.DateTime Fechacobro, out double Totalcobrado, out int Cantidadcobros, out string Codigoretorno, out string Mensajeretorno) {
            Sucive.MA_08.ExecuteRequest inValue = new Sucive.MA_08.ExecuteRequest();
            inValue.Nrocobrodesde = Nrocobrodesde;
            inValue.Nrocobrohasta = Nrocobrohasta;
            inValue.Fechacobro = Fechacobro;
            Sucive.MA_08.ExecuteResponse retVal = ((Sucive.MA_08.Ws08bCobradoDetalleSoapPort)(this)).Execute(inValue);
        ...
        public System.Threading.Tasks.Task<Sucive.MA_08.ExecuteResponse> ExecuteAsync(Sucive.MA_08.ExecuteRequest request) {
