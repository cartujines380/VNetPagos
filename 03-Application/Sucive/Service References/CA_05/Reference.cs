...
namespace Sucive.CA_05 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="GeoTribUy", ConfigurationName="CA_05.Ws05ConfirmacionSoapPort")]
    public interface Ws05ConfirmacionSoapPort {
        ...
        Sucive.CA_05.ExecuteResponse Execute(Sucive.CA_05.ExecuteRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="GeoTribUyaction/AWS05CONFIRMACION.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Sucive.CA_05.ExecuteResponse> ExecuteAsync(Sucive.CA_05.ExecuteRequest request);
    }
    ...
    public partial class ExecuteRequest {
        ...
        public Sucive.CA_05.ExecuteRequestBody Body;
        
        public ExecuteRequest() {
        }
        
        public ExecuteRequest(Sucive.CA_05.ExecuteRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ExecuteResponse {
        ...
        public Sucive.CA_05.ExecuteResponseBody Body;
        
        public ExecuteResponse() {
        }
        
        public ExecuteResponse(Sucive.CA_05.ExecuteResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Ws05ConfirmacionSoapPortChannel : Sucive.CA_05.Ws05ConfirmacionSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Ws05ConfirmacionSoapPortClient : System.ServiceModel.ClientBase<Sucive.CA_05.Ws05ConfirmacionSoapPort>, Sucive.CA_05.Ws05ConfirmacionSoapPort {
        ...
        Sucive.CA_05.ExecuteResponse Sucive.CA_05.Ws05ConfirmacionSoapPort.Execute(Sucive.CA_05.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public long Execute(long Numeroprefactura, string Sucursal, out string Codigoretorno, out string Mensajeretorno) {
            Sucive.CA_05.ExecuteRequest inValue = new Sucive.CA_05.ExecuteRequest();
            inValue.Body = new Sucive.CA_05.ExecuteRequestBody();
            inValue.Body.Numeroprefactura = Numeroprefactura;
            inValue.Body.Sucursal = Sucursal;
            Sucive.CA_05.ExecuteResponse retVal = ((Sucive.CA_05.Ws05ConfirmacionSoapPort)(this)).Execute(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Sucive.CA_05.ExecuteResponse> Sucive.CA_05.Ws05ConfirmacionSoapPort.ExecuteAsync(Sucive.CA_05.ExecuteRequest request) {
            return base.Channel.ExecuteAsync(request);
        }
        
        public System.Threading.Tasks.Task<Sucive.CA_05.ExecuteResponse> ExecuteAsync(long Numeroprefactura, string Sucursal) {
            Sucive.CA_05.ExecuteRequest inValue = new Sucive.CA_05.ExecuteRequest();
            inValue.Body = new Sucive.CA_05.ExecuteRequestBody();
            inValue.Body.Numeroprefactura = Numeroprefactura;
            inValue.Body.Sucursal = Sucursal;
            return ((Sucive.CA_05.Ws05ConfirmacionSoapPort)(this)).ExecuteAsync(inValue);
        }
    }
}
