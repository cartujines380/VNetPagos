...
namespace Sucive.FO_08 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="GeoTribUy", ConfigurationName="FO_08.Ws08bCobradoDetalleSoapPort")]
    public interface Ws08bCobradoDetalleSoapPort {
        ...
        Sucive.FO_08.ExecuteResponse Execute(Sucive.FO_08.ExecuteRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="GeoTribUyaction/AWS08BCOBRADODETALLE.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Sucive.FO_08.ExecuteResponse> ExecuteAsync(Sucive.FO_08.ExecuteRequest request);
    }
    ...
    public partial class ExecuteResponse {
        ...
        public Sucive.FO_08.SDT_WS08bTotalesCobrosSDT_WS08bTotalesCobrosItem[] Sdttotales;
        ...
        public ExecuteResponse(Sucive.FO_08.SDT_WS08bTotalesCobrosSDT_WS08bTotalesCobrosItem[] Sdttotales, double Totalcobrado, int Cantidadcobros, string Codigoretorno, string Mensajeretorno) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Ws08bCobradoDetalleSoapPortChannel : Sucive.FO_08.Ws08bCobradoDetalleSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Ws08bCobradoDetalleSoapPortClient : System.ServiceModel.ClientBase<Sucive.FO_08.Ws08bCobradoDetalleSoapPort>, Sucive.FO_08.Ws08bCobradoDetalleSoapPort {
        ...
        Sucive.FO_08.ExecuteResponse Sucive.FO_08.Ws08bCobradoDetalleSoapPort.Execute(Sucive.FO_08.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public Sucive.FO_08.SDT_WS08bTotalesCobrosSDT_WS08bTotalesCobrosItem[] Execute(long Nrocobrodesde, long Nrocobrohasta, System.DateTime Fechacobro, out double Totalcobrado, out int Cantidadcobros, out string Codigoretorno, out string Mensajeretorno) {
            Sucive.FO_08.ExecuteRequest inValue = new Sucive.FO_08.ExecuteRequest();
            inValue.Nrocobrodesde = Nrocobrodesde;
            inValue.Nrocobrohasta = Nrocobrohasta;
            inValue.Fechacobro = Fechacobro;
            Sucive.FO_08.ExecuteResponse retVal = ((Sucive.FO_08.Ws08bCobradoDetalleSoapPort)(this)).Execute(inValue);
        ...
        public System.Threading.Tasks.Task<Sucive.FO_08.ExecuteResponse> ExecuteAsync(Sucive.FO_08.ExecuteRequest request) {
