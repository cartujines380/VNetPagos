...
namespace Sucive.CO_06 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="GeoTribUy", ConfigurationName="CO_06.Ws06ReversoSoapPort")]
    public interface Ws06ReversoSoapPort {
        ...
        Sucive.CO_06.ExecuteResponse Execute(Sucive.CO_06.ExecuteRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="GeoTribUyaction/AWS06REVERSO.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Sucive.CO_06.ExecuteResponse> ExecuteAsync(Sucive.CO_06.ExecuteRequest request);
    }
    ...
    public partial class ExecuteRequest {
        ...
        public Sucive.CO_06.ExecuteRequestBody Body;
        
        public ExecuteRequest() {
        }
        
        public ExecuteRequest(Sucive.CO_06.ExecuteRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ExecuteResponse {
        ...
        public Sucive.CO_06.ExecuteResponseBody Body;
        
        public ExecuteResponse() {
        }
        
        public ExecuteResponse(Sucive.CO_06.ExecuteResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Ws06ReversoSoapPortChannel : Sucive.CO_06.Ws06ReversoSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Ws06ReversoSoapPortClient : System.ServiceModel.ClientBase<Sucive.CO_06.Ws06ReversoSoapPort>, Sucive.CO_06.Ws06ReversoSoapPort {
        ...
        Sucive.CO_06.ExecuteResponse Sucive.CO_06.Ws06ReversoSoapPort.Execute(Sucive.CO_06.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public string Execute(long Numeroprefactura, int Idpadcod, out string Mensajeretorno) {
            Sucive.CO_06.ExecuteRequest inValue = new Sucive.CO_06.ExecuteRequest();
            inValue.Body = new Sucive.CO_06.ExecuteRequestBody();
            inValue.Body.Numeroprefactura = Numeroprefactura;
            inValue.Body.Idpadcod = Idpadcod;
            Sucive.CO_06.ExecuteResponse retVal = ((Sucive.CO_06.Ws06ReversoSoapPort)(this)).Execute(inValue);
            Mensajeretorno = retVal.Body.Mensajeretorno;
            return retVal.Body.Codigoretorno;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Sucive.CO_06.ExecuteResponse> Sucive.CO_06.Ws06ReversoSoapPort.ExecuteAsync(Sucive.CO_06.ExecuteRequest request) {
            return base.Channel.ExecuteAsync(request);
        }
        
        public System.Threading.Tasks.Task<Sucive.CO_06.ExecuteResponse> ExecuteAsync(long Numeroprefactura, int Idpadcod) {
            Sucive.CO_06.ExecuteRequest inValue = new Sucive.CO_06.ExecuteRequest();
            inValue.Body = new Sucive.CO_06.ExecuteRequestBody();
            inValue.Body.Numeroprefactura = Numeroprefactura;
            inValue.Body.Idpadcod = Idpadcod;
            return ((Sucive.CO_06.Ws06ReversoSoapPort)(this)).ExecuteAsync(inValue);
        }
    }
}
