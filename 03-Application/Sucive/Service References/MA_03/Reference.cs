...
namespace Sucive.MA_03 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="GeoTribUy", ConfigurationName="MA_03.Ws03ConsultaDeudaCCSoapPort")]
    public interface Ws03ConsultaDeudaCCSoapPort {
        ...
        Sucive.MA_03.ExecuteResponse Execute(Sucive.MA_03.ExecuteRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="GeoTribUyaction/AWS03CONSULTADEUDACC.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Sucive.MA_03.ExecuteResponse> ExecuteAsync(Sucive.MA_03.ExecuteRequest request);
    }
    ...
    public partial class ExecuteResponse {
        ...
        public Sucive.MA_03.SDT_ColeccionCobranzaSDT_ColeccionCobranzaItem[] Sdtcoleccioncobranza;
        ...
        public ExecuteResponse(Sucive.MA_03.SDT_ColeccionCobranzaSDT_ColeccionCobranzaItem[] Sdtcoleccioncobranza, long Auxiliarcobro, string Codigoretorno, string Mensajeretorno) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Ws03ConsultaDeudaCCSoapPortChannel : Sucive.MA_03.Ws03ConsultaDeudaCCSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Ws03ConsultaDeudaCCSoapPortClient : System.ServiceModel.ClientBase<Sucive.MA_03.Ws03ConsultaDeudaCCSoapPort>, Sucive.MA_03.Ws03ConsultaDeudaCCSoapPort {
        ...
        Sucive.MA_03.ExecuteResponse Sucive.MA_03.Ws03ConsultaDeudaCCSoapPort.Execute(Sucive.MA_03.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public Sucive.MA_03.SDT_ColeccionCobranzaSDT_ColeccionCobranzaItem[] Execute(int Idpadron, string Utilizacc, string Tipoclave, out long Auxiliarcobro, out string Codigoretorno, out string Mensajeretorno) {
            Sucive.MA_03.ExecuteRequest inValue = new Sucive.MA_03.ExecuteRequest();
            inValue.Idpadron = Idpadron;
            inValue.Utilizacc = Utilizacc;
            inValue.Tipoclave = Tipoclave;
            Sucive.MA_03.ExecuteResponse retVal = ((Sucive.MA_03.Ws03ConsultaDeudaCCSoapPort)(this)).Execute(inValue);
        ...
        public System.Threading.Tasks.Task<Sucive.MA_03.ExecuteResponse> ExecuteAsync(Sucive.MA_03.ExecuteRequest request) {
