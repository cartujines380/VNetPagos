...
namespace Sucive.CA_06 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="GeoTribUy", ConfigurationName="CA_06.Ws06ReversoSoapPort")]
    public interface Ws06ReversoSoapPort {
        ...
        Sucive.CA_06.ExecuteResponse Execute(Sucive.CA_06.ExecuteRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="GeoTribUyaction/AWS06REVERSO.Execute", ReplyAction="*")]
        System.Threading.Tasks.Task<Sucive.CA_06.ExecuteResponse> ExecuteAsync(Sucive.CA_06.ExecuteRequest request);
    }
    ...
    public partial class ExecuteRequest {
        ...
        public Sucive.CA_06.ExecuteRequestBody Body;
        
        public ExecuteRequest() {
        }
        
        public ExecuteRequest(Sucive.CA_06.ExecuteRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class ExecuteResponse {
        ...
        public Sucive.CA_06.ExecuteResponseBody Body;
        
        public ExecuteResponse() {
        }
        
        public ExecuteResponse(Sucive.CA_06.ExecuteResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Ws06ReversoSoapPortChannel : Sucive.CA_06.Ws06ReversoSoapPort, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Ws06ReversoSoapPortClient : System.ServiceModel.ClientBase<Sucive.CA_06.Ws06ReversoSoapPort>, Sucive.CA_06.Ws06ReversoSoapPort {
        ...
        Sucive.CA_06.ExecuteResponse Sucive.CA_06.Ws06ReversoSoapPort.Execute(Sucive.CA_06.ExecuteRequest request) {
            return base.Channel.Execute(request);
        }
        
        public string Execute(long Numeroprefactura, int Idpadcod, out string Mensajeretorno) {
            Sucive.CA_06.ExecuteRequest inValue = new Sucive.CA_06.ExecuteRequest();
            inValue.Body = new Sucive.CA_06.ExecuteRequestBody();
            inValue.Body.Numeroprefactura = Numeroprefactura;
            inValue.Body.Idpadcod = Idpadcod;
            Sucive.CA_06.ExecuteResponse retVal = ((Sucive.CA_06.Ws06ReversoSoapPort)(this)).Execute(inValue);
            Mensajeretorno = retVal.Body.Mensajeretorno;
            return retVal.Body.Codigoretorno;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Sucive.CA_06.ExecuteResponse> Sucive.CA_06.Ws06ReversoSoapPort.ExecuteAsync(Sucive.CA_06.ExecuteRequest request) {
            return base.Channel.ExecuteAsync(request);
        }
        
        public System.Threading.Tasks.Task<Sucive.CA_06.ExecuteResponse> ExecuteAsync(long Numeroprefactura, int Idpadcod) {
            Sucive.CA_06.ExecuteRequest inValue = new Sucive.CA_06.ExecuteRequest();
            inValue.Body = new Sucive.CA_06.ExecuteRequestBody();
            inValue.Body.Numeroprefactura = Numeroprefactura;
            inValue.Body.Idpadcod = Idpadcod;
            return ((Sucive.CA_06.Ws06ReversoSoapPort)(this)).ExecuteAsync(inValue);
        }
    }
}
