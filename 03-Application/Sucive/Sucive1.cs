...
namespace Sucive
{
    public class Sucive1 : BaseSucive, ISucive1
    {
        
        private readonly ILoggerService _loggerService;
        
        public Sucive1(ILoggerService loggerService, IServiceFixedNotification serviceFixedNotification)
        ...
        private Result1GetConsultaDeudaCc GetConsultaDeudaCc(int idPadron, string param)
        {
        ...
        private BillSuciveDto GetConsultaDeuda(long auxiliarCobro, AR_04.SDT_ColeccionCobranzaSDT_ColeccionCobranzaItem[] array)
        {
        ...
        public long ConfirmarPago(long numeroPreFactura, string sucursal, string transactionId)
        {
            ...
            NotificationFix(numeroPreFactura.ToString(),transactionId,codigoretorno,mensajeretorno,DepartamentDtoType.Artigas, null);
        ...
        public BillSuciveDto CheckIfBillPayable(string lines, int idPadron, string param)
        {
            ...
            var list = new List<AR_04.SDT_ColeccionCobranzaSDT_ColeccionCobranzaItem>();
            foreach (var item in result.List)
            {
                var cobranza = new AR_04.SDT_ColeccionCobranzaSDT_ColeccionCobranzaItem()
                {
                    Anio = item.Anio,
                ...
                var dto = new ConciliationSuciveDto()
                          {
                              ...
                              Currency = "UYU",
                              Date = date,
                              Departament = DepartamentDtoType.Artigas
                          };
                list.Add(dto);
            }
            return list;
    ...
    {
        public AR_03.SDT_ColeccionCobranzaSDT_ColeccionCobranzaItem[] List { get; set; }
