...
using ServiceReference = VisaNet.Testing.DummyWCFPrueba.Demouy_Production_v02;

namespace VisaNet.Testing.DummyWCFPrueba.VersionTests
{
    public static class FirstVersionWcf
    {
        private static CultureInfo _culture;
        private const string Folder = "FirstVersionData";
            ...
            using (var r = new StreamReader(path))
            {
                ...
                foreach (var consulta in info)
                {
                    ...
                    if (result.Comercios != null && result.Comercios.Any())
                    {
                        ...
                        {
                            Console.WriteLine("Comercio: " + comercio.Nombre);
                        }
                    }
                    else
                    {
