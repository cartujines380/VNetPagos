...
using ServiceReference = VisaNet.Testing.DummyWCFPrueba.Azure_VisaNet_v020211;
//using ServiceReference = VisaNet.Testing.DummyWCFPrueba.Demouy_Production_v020211;

namespace VisaNet.Testing.DummyWCFPrueba.VersionTests
{
    public static class SecondVersionWcf
    {
        private static CultureInfo _culture;
        private const string Folder = "SecondVersionData";
