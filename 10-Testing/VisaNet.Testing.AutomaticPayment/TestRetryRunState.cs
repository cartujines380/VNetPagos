...
{
    public class TestRetryRunState : RetryRunState
    {
        ...
        public TestRetryRunState(IServiceServiceAssosiate serviceServiceAssosiate, IServiceProcessHistory processHistoryService)
        ...
        public override void UpdateProcessHistory(bool fatalError = false)
        {
            ...
            //En RetryRunState no se esta actualizando esto pero para los Tests se necesita
