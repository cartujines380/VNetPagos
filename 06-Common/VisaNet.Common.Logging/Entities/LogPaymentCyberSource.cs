...
{
    public class LogPaymentCyberSource
    {
        [Key]
        public Guid Id { get; set; }
        public Guid TransactionIdentifier { get; set; }
        public DateTime TransactionDateTime { get; set; }
        public CyberSourceLogData CyberSourceLogData { get; set; }
        public CyberSourceVerifyByVisaData CyberSourceVerifyByVisaData { get; set; }
    ...
    [ComplexType]
    public class CyberSourceLogData
    {
    ...
    public class CyberSourceVerifyByVisaData
    {
